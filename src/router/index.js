...
const routes = [
  ...
  {
    path: '/finalresult/:lang/:id',
    name: 'FinalResultView',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/FinalResultView.vue')
  },
  {
    path: '/name/:lang/:id',
    name: 'NameView',
  ...
  {
    path: '/myresult/:lang/:id/:username',
    name: 'MyResultView',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/MyResultView.vue')
  },
  {
    path: '/joinquiz/:lang',
    name: 'JoinView',
